...
- (void)viewDidLoad {
    ...
    [self addDebugOperate];
}

- (void)addDebugOperate
{
    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(toDebugView)];
...
- (void)toDebugView
{
    KNTADebugViewController *ctrl = [[KNTADebugViewController alloc] init];
